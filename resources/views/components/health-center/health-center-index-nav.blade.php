<section class="w-full relative overflow-x-hidden" id="main-section">
    ...
    <div class="block lg:hidden w-full bg-transparent fixed top-0 left-0 z-50">
        <div class="w-full flex items-center justify-between px-4 py-2" id="small-nav">
            ...
            <div class="small-header font-semibold mx-auto text-white uppercase text-lg"><h1>Mwecau Health Center</h1></div>
        ...
        <aside class=" fixed top-0 right-0 w-full py-2 block bg-purple-500 bg-opacity-90 bg-black-300 h-screen transform transition-transform duration-300 ease-out scale-0" id="navbar">
            ...
            <ul class="w-full pt-4 flex flex-col items-center text-lg text-white font-semibold">
                ...
                <li class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400 group relative">
                    ...
                    <ul class="w-max transform transition-transform duration-300 translate-y-[-20px] opacity-0 group-hover:translate-y-0 group-hover:opacity-100 absolute left-0 mt-3 bg-white shadow-lg text-purple-800 pointer-events-none group-hover:pointer-events-auto">
                        <li class="px-4 py-2 hover:bg-purple-100"><a href="">Cardiology</a></li>
                        <li class="px-4 py-2 hover:bg-purple-100"><a href="">Haematology and Cancer</a></li>
                    </ul>
                </li>

                <a href="{{route('health.services')}}" class="px-4 py-3 hover:text-purple-800 hover:border-b-2 border-purple-800">
                    <li>Services</li>
                </a>
                <a href="{{route('health.events')}}" class="px-4 py-3 hover:text-purple-800 hover:border-b-2 border-purple-800">
                    <li>Events</li>
                </a>
                <a href="" class="px-4 py-3 hover:text-purple-800 hover:border-b-2 border-purple-800">
                    <li>Gallery</li>
    ...
    {{-- large nav --}}
    <div class="main-nav hidden lg:flex w-full flex items-center justify-between bg-transparent py-4 px-8 fixed top-0 left-0 z-50 ">
        <div class="w-4/12 flex items-center lg:mr-auto">
            <img src="../../img/mwecau.png" alt="mwecau logo" class="w-3/12 rounded transition-transform duration-1000 mr-2" id="logo">
            ...
            <ul class="w-max ml-auto flex items-center text-lg text-white font-semibold">
                ...
                {{-- <a href="" class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400"> --}}
                    <li class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400 group relative">
                        ...
                        <ul class="w-max opacity-0 transform transition-opacity duration-500 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 absolute left-0 mt-3 bg-white shadow-lg text-purple-800">
                            <li class="px-4 py-2 hover:bg-purple-100"><a href="">Cardiology</a></li>
                            <li class="px-4 py-2 hover:bg-purple-100"><a href="">Haematology and Cancer</a></li>
                        </ul>
                    </li>
                ...
                {{-- </a> --}}
                <a href="{{route('health.services')}}" class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400">
                    <li>Services</li>
                </a>
                <a href="{{route('health.events')}}" class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400">
                    <li>Events</li>
                </a>
                <a href="" class="px-3 px-4 py-2 hover:text-purple-400 hover:border-b-2 border-purple-400">
                    <li>Gallery</li>
    ...
    <div class="overlay">
        <div class="center-div lg:static lg:v-center-div w-full lg:w-max">
            <div class="lg:static flex flex-col lg:block items-center w-full lg:w-2/5 lg:mr-auto pt-10 md:py-5 lg:pl-8 lg:ml-2 text-white bg-header">
                <h1 class="text-md lg:text-6xl text-center lg:text-left">Empowering Recovery on Your Journey to Wellness</h1>
