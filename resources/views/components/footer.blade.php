                    ...
                    <ul class="list-unstyled">
                        @if ($postgraduateJoiningInstruction)
                            <li class="mb-3"><a target="_blank"
                                    ...
                                    target="_blank" class="text-light">Joining Instruction (Postgraduate)</a></li>
                        @else
                            <li class="mb-3"><a
                        ...
                        @if ($undergrduateJoiningInstruction)
                            <li class="mb-3"><a target="_blank"
                                    ...
                                    target="_blank" class="text-light">Joining Instruction (Undergraduate)</a></li>
                        @else
                            <li class="mb-3"><a
                                    href="https://mwecau.ternet.or.tz/storage/files/1/Joining_Instruction/Joining-Instructions-for-postgraduate-students-2022-2023.pdf"
                                    target="_blank" class="text-light">Joining Instruction (Undergraduate)</a></li>
                        ...
                        @if ($NondegreeJoiningInstruction)
                            <li class="mb-3"><a target="_blank"
                                    ...
                                    target="_blank" class="text-light">Joining Instruction (Non-Degree)</a></li>
                        @else
                            <li class="mb-3"><a
                                    href="https://mwecau.ternet.or.tz/storage/files/1/Joining_Instruction/Joining-Instructions-for-postgraduate-students-2022-2023.pdf"
                                    target="_blank" class="text-light">Joining Instruction (Postgraduate)</a></li>
