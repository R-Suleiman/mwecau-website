...
<section class="w-full">
        ...
        <div class="relative w-full p-4 text-white font-semibold mx-auto rounded-3xl  bg-cover bg-center  overflow-hidden h-full" style="background-image: url('{{ asset('img/projects/project.jpg') }}')">
            <div class="overlay group hover:opacity-80">
                <div class="w-fit absolute left-40 transition-transform transform duration-1000 -translate-y-[100%] group-hover:translate-y-24">
                    <a href="{{ route('single-project') }}"><button class="p-2 border-2 border-white text-white bg-purple-500 text-xl">Read More</button></a>
                </div>
                <div class="absolute bottom-2 w-full px-8 py-2 flex justify-between items-center">
                    ...
                    <div class="w-fit ml-4">
                        ...
                        <h3 class="text-xl">Mtu ni Watu</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-1/3  p-4 my-2 h-96">
        <div class="relative w-full p-4 text-white font-semibold mx-auto rounded-3xl  bg-cover bg-center  overflow-hidden h-full" style="background-image: url('{{ asset('img/projects/project.jpg') }}')">
            <div class="overlay group hover:opacity-80">
                <div class="w-fit absolute left-40 transition-transform transform duration-1000 -translate-y-[100%] group-hover:translate-y-24">
                    <a href="#"><button class="p-2 border-2 border-white text-white bg-purple-500 text-xl">Read More</button></a>
                </div>
                <div class="absolute bottom-2 w-full px-8 py-2 flex justify-between items-center">
                    <div class="w-fit bg-white p-3 rounded-full">
                        <i class="fa fa-microscope text-4xl text-blue-800"></i>
