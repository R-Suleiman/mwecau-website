...
@section('content')
    {{-- //parent div --}}
    <div
        class="w-[70rem] mx-auto flex flex-col justify-center items-center text-gray-900 uppercase text-center rounded-md py-4 px-7 mt-7 bg-gray-100">
        <h1
    ...
    <div class="flex items-center justify-center p-7">
        <div class="w-full p-8 bg-white rounded-2xl shadow-2xl shadow-purple-200">
            ...
            <div class="w-full">
                <form action="{{ route('admin.project.publication.update', $publication->id) }}" method="POST"
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="author" name="author" value="{{ $publication->author }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="about_publication" id="editor" cols="30" rows="10"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out">{{ $publication->about_publication }}</textarea>
                        ...
                        <div class="mb-4">
                            <label for="year" class="block text-sm mb-4 font-medium text-gray-700">Year of
                                Publication</label>
                            <input type="text" id="year" name="year" value="{{ $publication->year }}"
                                placeholder="eg. MWECAU 2025 full funded scholarships"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
