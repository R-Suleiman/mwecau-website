...
@section('content')
    ...
    <div class="flex items-center justify-center p-7">
        <div class="w-full p-8 bg-white rounded-2xl shadow-2xl shadow-purple-200">
            ...
            <div class="w-full">
                <form action="{{ route('admin.project.conference.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-4">
                    @csrf
                    @method('POST')
                    ...
                    <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="location" id="location" name="location" value="{{ old('location') }}"
