                ...
                <form action="{{ route('admin.project.update-project', $project->id) }}" method="POST"
                    ...
                    <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="category" id="category" name="category" value="{{ $project->category }}"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="date" value="{{ $project->date }}" name="date"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                        ...
                        <!-- PDF file -->
                        <div class="mb-4">
                            <label for="pdf" class="block text-sm mb-4 font-medium text-gray-700">Project PDF (if
                                Applicable) </label>
                            <input type="file" id="pdf" name="pdf"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                            @if ($project->pdf == null)
                                <span class="text-red-600 font-semibold">No attachment available</span>
                            @else
                                <div class="flex items-center justify-end mt-4">
                                    <a href="#"
                                        class="py-2 px-4 text-xs uppercase font-semibold rounded-md bg-emerald-500 border border-transparent">Preview
                                        Attachment</a>
                                </div>
                            @endif
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-4 w-[70rem]">
                            ...
                            <textarea name="project_objectives" id="editor1" cols="30" rows="10"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out">{!! $project->project_objectives !!}</textarea>
                        ...
                        <div class="mb-4 w-[70rem]">
                            ...
                            <textarea name="project_outputs" id="editor2" cols="30" rows="10"
                                class="editor w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out">{!! $project->project_outputs !!}</textarea>
