    ...
    <section class="main-section">
        <div class="main-content">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card ">
                            <div class="card-body">
                                <div class="text-center mb-4"> <img src="{{ asset('images/staffProfiles/' . $staffProfile->staffProfile_picture) }}" class="img-fluid rounded-circle w-50"
                                        alt="" style="background-color: rgb(107, 107, 252)"></div>
                                ...
                                <div class="card-text text-center ">
                                    ...
                                    <span> <strong>Public relation officer (PRO)</strong> </span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-box">
                ...
                <div class="container ">
                    <div class="about">
                        <span class="favColor">About {{ $staffProfile->firstName }}</span>
