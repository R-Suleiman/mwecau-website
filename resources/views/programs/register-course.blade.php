...
<head>
    ...
    <title>Mwecau | register Course</title>
...
<body>
    ...
    <div class="container mb-4 mt-4">
        <h1 class="">REGISTER NEW COURSE</h1>
        <form action="{{ route('storeCorse') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
            ...
            <div class="row mt-4 ">
                ...
                <div class="col-12 col-md-6 col-lg-6 mb-4">
                    ...
                    <textarea name="course_description" class="form-control @error('course_description') is-invalid @enderror"
                        id="course_description" value="{{ old('course_description') }}" cols="30" rows="10" placeholder="Detailed description for the course"></textarea>
