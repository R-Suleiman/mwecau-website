...
@section('content')
    <div class="container mb-4 mt-4">
        ...
        <x-messages />
        <form action="{{ route('admin.udate.resource', $editResearch->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mt-4 ">
                <div class="col-12 col-md-6 col-lg-6 mb-4">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                        value="{!! $editResearch->header !!}" name="header" id="header" placeholder="Enter Project Header">
