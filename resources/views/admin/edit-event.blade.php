                        ...
                        <div class="event-form2">
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" id="eventEnd_time"
                                    value="{{ $event->eventEnd_time }}" name="eventEnd_time"
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" id="event_organizer"
                                    value="{{ $event->event_organizer }}" name="event_organizer"
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" id="total_slots"
                                    value="{{ $event->total_slots }} " name="total_slots" placeholder="e.g. 100" />
                            </div>
                            <div class="event-detail">
                                <div>
                                ...
                                <input type="text" class="form-control" value="{{ $event->booked_slots }}"
