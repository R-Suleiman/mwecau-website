                        ...
                        <div class="about-event col-sm-12 darkMode">
                            ...
                            <div class="event-form2">
                                ...
                                <textarea name="event_description" id="event_description" cols="50" rows="5"
                                    class="form-control darkMode @error('event_description') @enderror is-invalid" placeholder="Event Description">{{ $event->event_description }}</textarea>
                        ...
                        <div class="event-speaker darkMode">
                            ...
                            <div class="event-form2">
                                <div class="event-inputs">
                                    <input type="text" class="form-control"  value="{{ $event->speaker_fullname }}"  id="speaker_fullname" name="speaker_fullname"
