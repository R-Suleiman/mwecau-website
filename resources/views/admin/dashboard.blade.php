...
@section('content')
    ...
    <div class="content-box">
        ...
        {{-- events --}}
        <div class="category-content events-table w-100">
            @php
                $eventCounter = 1;
            @endphp
            ...
            <div class="view-all-btn">
                <a href="{{ route('admin.events.list') }}">
                    <button class="btn favbg">View all >></button>
                </a>
            </div>
        </div>
        {{-- staff --}}
        <div class="category-content staff-table w-100">
                        ...
                        @foreach ($faculty['departments'] as $department)
                            @foreach ($department['programmes'] as $programme)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.course.details', $programme['programme_name']) }}"><button
                                                class="btn btn-outline-secondary">view</button></a>
                                    </td>
                                </tr>
                            @endforeach
