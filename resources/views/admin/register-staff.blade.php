        ...
        <div class="main-content">
            ...
            <div class="container mt-5 ">
                <form action="{{ route('registerStaff') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-4">
                            <h2 class="text-center fw-bold favColor">{{ 'Mwecau staff registration panel' }}</h2>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            ...
                            <input type="text" class="form-control @error('gender') is-invalid @enderror"
                                value="{{ old('gender') }}" id="gender" name="gender" placeholder="male or female">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 mb-4">
                            ...
                            <input type="text" class="form-control @error('language') is-invalid @enderror"
                                value="{{ old('language') }}" id="language" name="language"
