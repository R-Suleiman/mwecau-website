                        ...
                        <div class="about-event col-sm-12 darkMode">
                            ...
                            <div class="event-form2">
                                <div class="event-inputs col-sm-12 ">
                                    <input type="text" value="{{ old('event_title') }}" class="form-control darkMode"
                            ...
                            <div class="event-form2">
                                <div class="event-inputs">
                                    <input type="text" class="form-control" id="speaker_fullname"
                                        value="{{ old('speaker_fullname') }}" name="speaker_fullname"
                                    ...
                                    <input type="text" class="form-control" id="speaker_profession"
                                        name="speaker_profession" value="{{ old('speaker_profession') }}"
                        ...
                        <div class="event-form2">
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" id="eventStart_time"
                                    value="{{ old('eventStart_time') }}" name="eventStart_time"
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" id="eventEnd_time"
                                    value="{{ old('eventEnd_time') }}" name="eventEnd_time"
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" value="{{ old('total_slots') }}"
                                    id="total_slots" name="total_slots" placeholder="e.g. 100" />
                                <div>
                                    <span class="text-danger">
                                        @error('total_slots')
                                            {{ $message }}
                            ...
                            <div class="event-detail">
                                ...
                                <input type="text" class="form-control" value="{{ old('booked_slots') }}"
                                    id="booked_slots" name="booked_slots" />
                                <div>
                                    <span class="text-danger">
                                        @error('booked_slots')
                                            {{ $message }}
