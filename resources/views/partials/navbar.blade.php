                          ...
                          <ul class="navbar-nav mx-auto">
                              ...
                              <li class="nav-item dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="{{ route('events') }}">Action</a></li>
                                      <li><a class="dropdown-item" href="{{ route('register-course') }}">Another action</a></li>
                                      <li>
                                          <hr class="dropdown-divider">
                                      </li>
                                      <li><a class="dropdown-item" href="{{ route('course-list') }}">course list (web display)</a></li>
                                      <li><a class="dropdown-item" href="{{ route('mwecau-staffs') }}">staff list (web display)</a></li>
                                      <li><a class="dropdown-item" href="{{ route('register-staff') }}">register staff (admin route)</a></li>
