...
@section('content')
    ...
    <section class="w-10/12 mx-auto p-4 my-4">
        ...
        <p class="text-lg text-default-text my-2 text-justify">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel eum voluptas dolore placeat veniam. Mollitia quibusdam vel facilis minus neque debitis eius quae inventore atque cupiditate quisquam, ad molestiae omnis.
        Ipsa incidunt fugiat quo adipisci consequuntur consequatur maiores? Dolore nulla corporis praesentium nobis quidem cum laborum illum? Doloremque, officia. Quod, voluptatem! Cum totam eaque architecto voluptate quia provident ipsum soluta.
        Deleniti possimus et molestiae perferendis veritatis alias velit, illum, corrupti voluptatibus molestias dolor odio sunt repudiandae praesentium. Dolores nisi rem optio, rerum quia, natus doloremque et, quisquam ipsum sit aliquam.</p>
    </section>
    ...
    <section class="w-full flex flex-col md:flex-row my-4">
        <div class="w-1/3 my-4">
            <div class="w-11/12 mx-auto p-4 flex flex-col items-center shadow-md shadow-blue-800 rounded-lg">
                ...
                <p class="text-lg text-default-text text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt nam non ut dolor. Commodi porro voluptatibus eum error, delectus, odio nihil fuga quos optio, sit deserunt. Repellat consequuntur delectus voluptas.</p>
            </div>
        </div>
        <div class="w-1/3 my-4">
            <div class="w-11/12 mx-auto p-4 flex flex-col items-center shadow-md shadow-blue-800 rounded-lg">
    ...
    <section class="flex flex-col lg:flex-row mt-4 bg-blue-900">
        ...
        <div class="w-full lg:w-1/2 p-8 text-blue-100 text-justify">
            ...
            <p class="py-2 text-justify text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Assumenda labore magni alias laborum
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem magnam facere porro incidunt. Ea blanditiis commodi at ipsam quam culpa nemo, corrupti pariatur itaque ad nulla dolorum odit quia et.
            </p>
        </div>
    </section>
    ...
    <section class="w-full px-4 py-10 lg:py-20 mb-4 flex flex-col items-center bg-neutral-100">
        ...
        <div class="my-4 p-4 w-full flex flex-col items-center lg:flex-row lg:space-x-8">
            <div class="w-full my-4 lg:my-0 lg:w-1/3 border border-gray-300 rounded-lg">
                <a href="{{ route('health-center-department') }}">
                    <div class="w-full mb-2 overflow-hidden">
        ...
        <div class="my-4 p-4 w-full flex flex-col items-center lg:flex-row lg:space-x-8">
            <div class="w-full my-4 lg:my-0 lg:w-1/4 border border-gray-300 rounded-md">
                    ...
                    <div class="w-full mt-2 p-4 text-justify flex flex-col">
                        ...
                        <span class="text-gray-400 text-md"><i class="fa fa-user-md mr-1"></i> Doctor's Designation</span>
                        <span class="text-gray-400 text-md"><i class="fa fa-stethoscope mr-1"></i> Cardiology</span>
                    </div>
            </div>
            <div class="w-full my-4 lg:my-0 lg:w-1/4 border border-gray-300 rounded-md">
