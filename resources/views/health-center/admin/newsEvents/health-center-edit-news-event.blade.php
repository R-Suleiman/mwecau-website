...
@section('content')
    ...
    <div class="flex items-center justify-center p-7">
        <div class="w-full p-8 bg-white rounded-2xl shadow-2xl shadow-purple-200">
            ...
            <div class="w-full">
                <form action="{{ route('health-center.update-news-event', $newsEvent->id) }}" method="POST" enctype="multipart/form-data"
                    class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" value="{{ $newsEvent->title }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="organizer" name="organizer" value="{{ $newsEvent->organizer }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" id="time" value="{{ $newsEvent->time }}" name="time"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="date" value="{{ $newsEvent->date }}" name="date"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="location" name="location" value="{{ $newsEvent->location }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="contact" name="contact" value="{{ $newsEvent->contact }}"
                                placeholder="Contact"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out" />
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="email" name="email" value="{{ $newsEvent->email }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="" cols="30" rows="10"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out">{{ $newsEvent->description }}</textarea>
