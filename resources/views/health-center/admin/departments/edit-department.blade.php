...
@section('content')
    ...
    <div class="flex items-center justify-center p-7">
        <div class="w-full p-8 bg-white rounded-2xl shadow-2xl shadow-purple-200">
            ...
            <div class="w-full">
                <form action="{{ route('health-center.update-department', $department->id) }}" method="POST"
                    ...
                    <div class="w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="" cols="30" rows="10"
                                class="w-full p-3 border border-purple-300 rounded-lg focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition duration-150 ease-in-out">{{ $department->description }}</textarea>
