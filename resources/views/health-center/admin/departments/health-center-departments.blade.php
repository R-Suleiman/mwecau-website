...
@section('content')
    ...
    <div class="text-end">
        ...
        <a href="{{ route('health-center.create-department') }}"
                        ...
                        @foreach ($departments as $department)
                            <tr class="hover:bg-gray-100 border border-gray-400">
                                ...
                                <td
                                    ...
                                    <a
                                        href="{{ route('health-center.edit-department', $department->name) }}">{!! Str::limit($department->name, '40') !!}</a>
                                </td>

                                <td class="px-4 py-2 flex items-center justify-center space-x-2">
                                    <a href="{{ route('health-center.edit-department', $department->name) }}"
                                    ...
                                    <form action="{{ route('health-center.destroy-department', $department->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
