...
@section('content')
    ...
    @foreach ($AllImages as $page => $images)
        <h4 class="text-lg mx-8 text-default-text mt-4">{{ $page }} page Images</h4>
        <div class="w-full flex p-4 flex-wrap items-center border-b border-default-text">
                @foreach ($images as $image)
                <div class="w-1/2 my-4 lg:w-1/3">
                    <div class="w-11/12 mx-auto shadow-sm shadow-orange-400 p-2">
