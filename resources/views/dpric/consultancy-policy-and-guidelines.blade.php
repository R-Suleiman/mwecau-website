    ...
    <section>
        <div class="flex flex-col my-4 p-4 ">
            <div class="w-fit mx-auto">
                <h2 class="uppercase text-xl lg:text-3xl text-center text-default-head">{{ $consultancyPolicy->title }}</h2>
        ...
        <div class=" w-11/12 mx-auto">
            <p class="my-4 text-lg text-default-text text-justify">{{ $consultancyPolicy->description }}</p>
        </div>
