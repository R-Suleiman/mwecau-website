...
@section('content')
    ...
    <section class="relative w-full h-96 bg-center bg-cover"
        style="background-image: url('{{ $club->primary_image ? asset('/storage/images/dpric/clubs/' . $club->primary_image) : asset('img/health-center/header.jpg') }}')">
        <div class="overlay">
    ...
    <section>
        ...
        <div
            ...
            <div class="w-full md:w-8/12 md:h-96">
                <img src="{{ $randomImg ? asset('/storage/images/dpric/clubs/clubs-gallery/' . $randomImg->image) : asset('img/health-center/header.jpg') }}"
        ...
        <div class="w-full mx-auto flex flex-col md:flex-row p-4 bg-blue-900 my-8">
            ...
            <div class="w-full md:w-1/2 p-4 my-4 text-blue-100">
                ...
                @else
                <span
                class="ml-2 text-2xl">No Activity Found!</span>
                @endif
            ...
            @if ($projects->count() > 0)
                ...
                <div class="mt-auto w-max mx-auto">
                    <button class="p-2 bg-purple-600 border-2 border-white text-white my-4"><a
                            href="{{ route('dpric.innovations-club-projects', $project->club->name) }}">All
                            Projects</a></button>
                </div>
            @else
        ...
        <div class="w-full p-4">
            ...
            @else
                <div class="w-2/3 mx-auto bg-blue-300 my-8 p-4 text-xl">No Leaders found!</div>
            @endif
        </div>
        ...
        <section class="w-full py-8">
            <div class="flex flex-col items-center w-max mb-4 mx-auto my-8">
                <h2 class="uppercase text-2xl text-center text-blue-800">Club's Gallery</h2>
