        ...
        <div class="overlay">
            <div class="center-div">
                <div class="text-white text-center">
                    <h1 class="text-4xl">Mwecau ICT Club</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        ...
        <div class="w-full md:w-10/12 mx-auto flex flex-col md:flex-row p-4">
            <div class="w-full md:w-2/3 p-4 my-4 order-2 md:order-1">
                ...
                <p class="text-lg my-2 text-default-text text-justify">Lorem ipsum dolor sit amet consectetur adipisicing
                    elit. Placeat similique a sunt error natus, voluptatem quam voluptates asperiores qui voluptate harum
                    consequatur suscipit iusto voluptatum illo? Iure est ex maxime.
                    Impedit iure deserunt debitis velit facilis nulla, sunt libero quas sapiente voluptatibus ipsum harum
                    ullam veniam vero voluptatum doloremque repellat, totam delectus! Minima rem possimus sint unde adipisci
                    tenetur praesentium?
                    Quod est beatae excepturi saepe labore enim ex blanditiis, asperiores quam, veniam dolor minus et,
                    dolore amet. Perferendis atque ex ullam sequi voluptas labore dolorum, veniam dolorem quasi quibusdam
                    minus.</p>
            </div>
            <div class="w-full md:w-1/3 my-0 md:my-4 order-1 md:order-2 border border-blue-800 rounded-md">
        ...
        <div class="w-full md:w-11/12 mx-auto flex flex-col md:flex-row p-4">
            <div class="flex flex-col w-full md:w-1/2 mx-auto px-4 py-2 shadow-sm shadow-blue-700 my-8 order-2 md:order-1">
                <div class="w-full px-4 md:px-8 my-2 ">
                    ...
                    <p class="text-default-text my-4 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Voluptatem ipsa aperiam laborum accusantium modi delectus pariatur. Doloremque qui sit voluptatem
                        consequatur commodi adipisci? Aspernatur distinctio temporibus commodi, aliquid nulla accusamus!</p>
                </div>
                <div class="w-full px-4 md:px-8 my-2">
                    <div class="flex justify-between">
            ...
            <div class="w-full md:w-4/12 p-4 md:h-96">
                <div class="w-11/12 mx-auto rounded-lg project-desc1">
                    <div class="project-desc my-6 flex flex-col">
                        ...
                        <span class="text-xl text-default-text">DNSIT</span>
                    </div>
                    <div class="project-desc my-6 flex flex-col">
                    ...
                    <div class="project-desc my-6 flex flex-col">
                        ...
                        <span class="text-xl text-default-text">60</span>
                    </div>
                    <div class="project-desc my-6 flex flex-col">
                        <label class="text-md text-blue-900">Projects</label>
                        <span class="text-xl text-default-text">3</span>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full mx-auto flex flex-col md:flex-row p-4 bg-blue-900 my-8">
            ...
            <div class="w-full md:w-1/2 p-4 my-4 text-blue-100">
                <div class="my-2"><i class="fa fa-check text-lg"></i> <span class="ml-2 text-2xl">Programming</span></div>
                <div class="my-2"><i class="fa fa-check text-lg"></i> <span class="ml-2 text-2xl">Networking and
                        Security</span></div>
                <div class="my-2"><i class="fa fa-check text-lg"></i> <span class="ml-2 text-2xl">AI and Robotics</span>
                </div>
                <div class="my-2"><i class="fa fa-check text-lg"></i> <span class="ml-2 text-2xl">Graphic Designing</span>
                </div>
            </div>
        </div>
