...
@section('content')
    ...
    <section class="w-full mt-8 lg:my-8 flex flex-col lg:flex-row md:p-4">
        <div class="w-full lg:w-7/12 p-4 lg:p-8 order-2 lg:order-1">
            <div class="w-full lg:w-10/12  lg:relative mx-auto">
                <img src="{{ asset('/storage/images/dpric/general/' . $welcomeImgs[0]->image_path) }}"
                    class="w-full rounded-3xl h-96 object-cover" alt="">
                <div class="w-7/12 hidden lg:block absolute -bottom-8 -right-8 rounded-full">
                    <img src="{{ asset('/storage/images/dpric/general/' . $welcomeImgs[1]->image_path) }}"
        ...
        <div class="w-full md:w-7/12 p-4 my-4 md:my-0 flex flex-col justify-between">
            <div class="w-full">
                <div class="flex flex-col mb-4 p-4">
                    <div class="w-fit">
                        <h2 class="uppercase text-xl lg:text-3xl text-center text-default-head">What Drives Us</h2>
                        ...
                        <div class="w-full lg:w-11/12 mx-auto relative h-96 bg-cover bg-center bg-no-repeat"
                            ...
                            <div
                                ...
                                <div class="w-full lg:w-4/6 bg-blue-800 opacity-85 bg-blend-multiply p-4 h-fit lg:h-96">
                                    <span
                                        class="bg-purple-900 text-white p-2 text-md md:text-lg rounded-lg md:mx-4">Category</span>
                                    <div class="p-2 text-white w-full">
                                        ...
                                        <p class="text-sm md:text-lg my-2 hidden lg:block">
                                            {!! Str::words($news->description, 30, '...') !!}</p>
                                        <span
    ...
    <section class="w-full p-2 my-4">
        ...
        <div class="w-full flex  shadow-lg shadow-purple-300 rounded-lg">
            <div class="w-full lg:w-1/2 px-2 lg:px-4" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="w-11/12 mx-auto">
                    <a href="/dpric/postgraduate-units">
                        <button class="w-full p-2 text-lg border-2 border-blue-800 mb-4 mt-12 hover:bg-blue-100">Discover
                            Research Units</button>
                    </a>
                </div>
            </div>
            <div class="w-full lg:w-1/2 overflow-hidden h-full">
                <img src="{{ asset('/storage/images/dpric/general/' . $unitsImg) }}" alt="" class="w-full object-cover">
            </div>
        </div>
    </section>
    ...
    <section class="w-full mt-8">
        <div class="w-full p-8">
            ...
            <p class="my-2 text-default-text text-md lg:text-xl text-center">{!! $researchMessage->description !!}
        </div>
        <div class="w-full py-8 flex flex-col justify-between">
            <div class="w-full flex flex-col lg:flex-row flex-wrap">
                @foreach ($projects->take(3) as $project)
                    <div class="w-full md:w-1/3 my-2">
                        <div class="w-11/12 mx-auto shadow-md shadow-gray-600">
                            <div class="w-full overflow-hidden h-60">
                                <img src="{{ asset('img/uni.jpg') }}" alt=""
                                    class="w-full object-cover object-center">
                                {{-- <img src="{{ asset('storage/images/projects/images/project-thumbnail/' . $project->thumbnail) }}"
                                    alt="" class="w-full object-cover object-center"> --}}
                            </div>
                            <div class="w-full p-4">
                                <h4 class="text-xl my-3 font-semibold">{{ $project->name }}</h4>
                                <p>{!! Str::words($project->description, 15, '...') !!} </p>
                            </div>

                            <div class="w-11/12 mx-auto">
                                <a href="{{ route('single-project', $project->name) }}">
                                    <button
                                        class="w-full p-2 text-lg border-2 border-blue-800 mb-4 mt-12 hover:bg-blue-100">Read
                                        More</button>
                                </a>
                            </div>
                        </div>
