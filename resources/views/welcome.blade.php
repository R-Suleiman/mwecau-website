...
<body>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="img/university-image1.JPG" class="d-block w-100 background-container" alt="university-image1" />
                    <div class="dark-overlay">
                        <div class="nav-content">
                            <h1 class="display-4 fw-bold">Example Quickly get a project started</h1>
                ...
                <div class="carousel-item">
                    <img src="img/university-image2.JPG" class="d-block w-100 background-container" alt="university-image2" />
                    <div class="dark-overlay">
                        <div class="nav-content">
                            <h1 class="display-4 fw-bold">Discover the world of possibility with MWECAU</h1>
                            <p>Call 2024 applications are now open</p>
    ...
    <section>
        <div class="container mt-3 mb-5">
            <div class="row g-lg-5 ">
                <div class="col-12 col-lg-5" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <a href="about.html"><button class="welcomeBtn mb-3 "> Read More <i class="fa fa-arrow-right"></i></button></a>
                </div>

                <div class="welcomeImgContainer col-12 col-lg-7">
                    <div class="image-container">
                        <img src="img/university-image3.JPG" alt="Welcome at Mwecau" style="width:100%; border: 1px solid #513f83; border-radius: 7px;">
                        <img class="overlay-image img-fluid  shadow-lg" src="img/students1.JPG" alt="Overlay Image" style="width: 50%;">
                    </div>
                </div>
    ...
    <section class="mt-5 mb-4">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 d-flex justify-content-end text-sm-start">
                    <a href="#"><button class="newsBtn"> View all News <i class="fa fa-arrow-right"></i></button></a>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="contain">
                        <div class="image-containerNews mb-5">
                            <img src="img/mwecau2.jpg" alt="Welcome at Mwecau" style="width:100%; border: 1px solid #513f83; border-radius: 7px;">
                            <div class="overlay-newsImage shadow-lg">
                                <div class="card">
                                    <div class="card-body p-3">
                                        <h5 class="fw-bold card-title fs-5">Vacancy</h5>
                                        <p class="card-text fst-italic">Vacancy Announcement, Deadline Friday 15-Sep-2023
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="image-containerNews">
                        <img src="img/university-image3.JPG" alt="Welcome at Mwecau" style="width:100%; border: 1px solid #513f83; border-radius: 7px;">
                        <div class="overlay-newsImage shadow-lg">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="fw-bold card-title fs-5">Swahili Training</h5>
                                    <p class="card-text fst-italic">Swahili Training for University of Georgia (UGA) International Students at...
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="image-containerNews">
                        <img src="img/uni.jpg" alt="Welcome at Mwecau" style="width:100%; border: 1px solid #513f83; border-radius: 7px;">
                        <div class="overlay-newsImage shadow-lg">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="fw-bold card-title fs-5">Conference</h5>
                                    <p class="card-text fst-italic">4th MWECAU International Conference Announcement
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <section>
        <div class="container my-5 py-5  text-center rounded" data-aos="fade-up" data-aos-duration="3000">
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-text">
                            ...
                            <div class="mb-3">
                                <a href="about.html"><button class="whyButtons"> Read More <i class="fas fa-arrow-right"></i> </button></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container text-center my-3 py-3">
            <div class="row justify-content-around align-items-start">
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="bottomBorder card" data-aos="fade-right" data-aos-duration="2000">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4" data-aos="fade-up" data-aos-duration="1000">
                    <div class="bottomBorder card">
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4" data-aos="fade-left" data-aos-duration="2000">
                    <div class="bottomBorder card">
                        <div class="card-body">
    ...
    <section>
        <div class="container text-center my-3 p-3">
            <div class="row justify-contents-around align-items-center">
                ...
                <div class="upComingEvent2 col-12 col-md-6 col-lg-3 mb-3">
                    <a href="about.html" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body"> <img src="img/mwecau.jpg" style="width: 100%;" alt=""></div>
                            <div class="card-text">
                                <p>
                ...
                <div class="upComingEvent2 col-12 col-md-6 col-lg-3 mb-3">
                    <a href="about.html" class="text-decoration-none">
                        <div class="card">
                            <div class="card-body"> <img src="img/university-image-4.JPG" style="width: 100%;" alt="">
                                <div class="card-text">
                                    <p>
            ...
            <div class="">
                <a href="{{ route('events') }}"><button class="eventsBtn"> More Mwecau Events <i class="fas fa-arrow-right"></i></button></a>
            </div>
